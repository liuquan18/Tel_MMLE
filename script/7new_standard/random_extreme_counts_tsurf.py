...
# %%
def read_data( ens_size,model = 'MPI_GE_onepct'):
...
def process_ens_size(ens_size):
    ...
    ds.to_netcdf(f"/work/mh0033/m300883/Tel_MMLE/data/MPI_GE_onepct_random/extreme_count/extreme_counts_tsurf_{str(ens_size)}.nc")
