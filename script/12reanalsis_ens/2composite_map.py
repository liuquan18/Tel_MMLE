...
# %%
first_ts = xr.open_dataset("/work/mh0033/m300883/Tel_MMLE/data/ERA5/composite/first_composite.nc")
last_ts = xr.open_dataset("/work/mh0033/m300883/Tel_MMLE/data/ERA5/composite/last_composite.nc")
# %%
