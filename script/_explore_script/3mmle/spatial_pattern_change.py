...
# %%
EOFs.to_netcdf(odir + "/EOF_result/ind_first_eofs_allPeriods.nc")
FRAs.to_netcdf(odir + "/EOF_result/ind_first_fras_allPeriods.nc")

# %%
sp_change.spatial_pattern_maps(EOFs, FRAs)
# %%

EOFs = xr.open_dataset(odir + "/EOF_result/ind_first_eofs_allPeriods.nc").eof
FRAs = xr.open_dataset(odir + "/EOF_result/ind_first_fras_allPeriods.nc").exp_var
# %%
